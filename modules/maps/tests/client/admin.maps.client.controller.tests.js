(function () {
  ...
  describe('maps Admin Controller Tests', function () {
    // Initialize global variables
    var mapsAdminController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _mapsService_, _Notification_) {
    ...
    describe('vm.save() as create', function () {
      ...
      beforeEach(function () {
        ...
        sampleArticlePostData = new mapsService({
          title: 'An Article about MEAN',
          content: 'MEAN rocks!'
        });
      ...
      it('should send a POST request with the form input values and then locate to new object URL', inject(function (mapsService) {
        // Set POST response
        $httpBackend.expectPOST('/api/maps', sampleArticlePostData).respond(mockArticle);
        ...
        expect($state.go).toHaveBeenCalledWith('admin.maps.list');
      }));

      it('should call Notification.error if error', function () {
        var errorMessage = 'this is an error message';
        $httpBackend.expectPOST('/api/maps', sampleArticlePostData).respond(400, {
    ...
    describe('vm.save() as update', function () {
      ...
      it('should update a valid article', inject(function (mapsService) {
        // Set PUT response
      ...
      it('should  call Notification.error if error', inject(function (mapsService) {
    ...
    describe('vm.remove()', function () {
      ...
      it('should delete the article and redirect to maps', function () {
