(function () {
  ...
  describe('Admin maps List Controller Tests', function () {
    // Initialize global variables
    var mapsAdminListController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _mapsService_) {
      ...
      $httpBackend.whenGET('/modules/maps/client/views/list-maps.client.view.html').respond(200, '');
      ...
      mapsAdminListController = $controller('mapsAdminListController as vm', {
        $scope: $scope
      });
