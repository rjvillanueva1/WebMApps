...
describe('Article CRUD tests', function () {
  ...
  it('should be able to get a single article if not signed in', function (done) {
    ...
    // Save the article
    articleObj.save(function () {
      agent.get('/api/maps/' + articleObj._id)
        .end(function (req, res) {
          // Set assertion
  ...
  it('should return proper error for single article which doesnt exist, if not signed in', function (done) {
    ...
    agent.get('/api/maps/559e9cd815f80b4c256a8f41')
      .end(function (req, res) {
        // Set assertion
  ...
  it('should not be able to delete an article if not signed in', function (done) {
    ...
    articleObj.save(function () {
      ...
      agent.delete('/api/maps/' + articleObj._id)
        .expect(403)
        ...
        .end(function (signinErr, signinRes) {
          ...
          agent.post('/api/maps')
            ...
            .end(function (mapsaveErr, mapsaveRes) {
              ...
              (mapsaveRes.body.title).should.equal(article.title);
        ...
        .end(function (signinErr, signinRes) {
          ...
          agent.post('/api/maps')
            ...
            .end(function (mapsaveErr, mapsaveRes) {
              ...
              (mapsaveRes.body.title).should.equal(article.title);
              should.exist(mapsaveRes.body.user);
              should.equal(mapsaveRes.body.user._id, userId);
